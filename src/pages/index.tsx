              ...
              <div className="kv_wrap">
                <div className="l-grid u-alignItems-center l-grid-vreverse-md l-gapVertSmall-md">
                  <div className="l-grid_item l-grid_item-12-md u-mt-x0_5-md">
                    <p className="kv-label u-tc-p5 u-fw-bold">法人向け</p>
                    <p className="u-ts-xlarge u-fw-medium">自動化・可視化を実現する</p>
                    <h2 className="kv_title u-ts-lv3 u-fw-bold">
                      統合型<span style={{ color: '#2964F0' }}>クラウド会計ソフト</span>
                    </h2>
                  </div>
                </div>
              </div>
            </div>
            <div className="swiper-slide kvslide-individual">
            </div>
